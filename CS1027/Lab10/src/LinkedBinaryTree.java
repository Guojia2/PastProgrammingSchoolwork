...
public class LinkedBinaryTree<T> implements BinaryTreeADT<T> {
	...
	public int size(BinaryTreeNode<T> r) {
		...
		int count = 1;
		if (r.getLeft() != null) {
			count = count + size(r.getLeft());
		}
		if (r.getRight() != null) {
			count = count + size(r.getRight());
		}
		return count;
	}
	...
	public boolean contains (BinaryTreeNode<T> r, T targetElement) {
		...
		if (r.getLeft() != null && contains(r.getLeft(), targetElement)) {
			//return contains(r.getLeft(), targetElement);
			return true;
		}
		if (r.getRight() != null &&contains(r.getRight(), targetElement) ) {
			//return contains(r.getRight(), targetElement);
			return true;
		}

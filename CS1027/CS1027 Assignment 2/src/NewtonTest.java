...
//		System.out.println( "Test 12 " + (test12() ? "passed" : "failed" ));
	...
	public static boolean test01() { 
		...
		p.add(1,2);
		// it might be duplicating this one incorrectly. Check your rewiring
		// I've checked hte toString() function, so the problem is not there
		p.add(-1,1);
		p.add(+1,0);
...
//		System.out.println(p.derivative().toString());
		...
		try {
			...
			System.out.println("THis line was reached");
			return false; // exception triggered.
		}
	}

...
# to find a flight between LAX and MIA, you should go LAx to CPT then CPT to MIA
#it seems that middleFLight is being set to the flight USO770,MEX,CPT instead of USO771,CPT,MEX. That means there's an error in the logic of the middle and end flight destinations and origins.
